...
public class RingAccessories {
    ...
    public static final RegistryObject<AccessoryItem> GLUTTONY_SIGNET_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Ring)
                    .withStats(new CustomStats.Builder().setInsight(1).setStr(1).setDex(1).setMoveSpeed(-15).setDebuffResist(-20)
                            .setFort(1).setArmor(1).setArmorToughness(1).setMaxHealth(1).setMeleeDamage(2)
                            .setAttackSpeed(2).setDrawSpeed(2).setProjectileDamage(2)
                            .setCon(1).setPerc(1).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> GLUTTONY_SIGNET_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Ring)
                    .withStats(new CustomStats.Builder().setInsight(2).setStr(2).setDex(2).setMoveSpeed(-15).setDebuffResist(-20)
                            .setFort(2).setArmor(1.5).setArmorToughness(1.5).setMaxHealth(1.25).setMeleeDamage(2.5)
                            .setAttackSpeed(2.5).setDrawSpeed(2.5).setProjectileDamage(2.5)
                            .setCon(2).setPerc(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> GLUTTONY_SIGNET_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Ring)
                    .withStats(new CustomStats.Builder().setInsight(3).setStr(3).setDex(3).setMoveSpeed(-15).setDebuffResist(-20)
                            .setFort(3).setArmor(2).setArmorToughness(2).setMaxHealth(1.5).setMeleeDamage(3.25)
                            .setAttackSpeed(3.25).setDrawSpeed(3.25).setProjectileDamage(3.25)
                            .setCon(3).setPerc(3)
                            .setArmorMultiplier(2).setToughnessMultiplier(2)
                            .setSpeedMultiplier(3).setMeleeDamageMultiplier(3).setDrawSpeedMultiplier(3).
                            setProjectileDamageMultiplier(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> GLUTTONY_SIGNET_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withStats(new CustomStats.Builder().setInsight(4).setStr(4).setDex(4).setMoveSpeed(-15)
                            ...
                            .setMaxHealth(1.75).setMeleeDamage(4).setAttackSpeed(4)
                            .setDrawSpeed(4).setProjectileDamage(4).setCon(4).setPerc(4)
                            .setArmorMultiplier(4).setToughnessMultiplier(4).setSpeedMultiplier(6)
                            .setMeleeDamageMultiplier(6).setDrawSpeedMultiplier(6)
                            .setProjectileDamageMultiplier(6).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> CORRUPTED_RING_OF_THE_LOST_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Ring)
                    .withStats(new CustomStats.Builder().setInsight(1).setFort(4).setKnockbackResist(5).setArmor(2.25).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    public static final RegistryObject<AccessoryItem> CORRUPTED_RING_OF_THE_LOST_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Ring)
                    .withStats(new CustomStats.Builder().setInsight(2).setFort(5).setKnockbackResist(10).setArmor(3.75).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
