...
public class NecklaceAccessories {
    ...
    public static final RegistryObject<AccessoryItem> COLLAR_OF_ENVY_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setDex(5).setMeleeDamage(9).setFort(4).setArmorToughness(4).setMeleeDamageMultiplier(0.05).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> COLLAR_OF_ENVY_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setDex(6).setMeleeDamage(12).setFort(6).setArmorToughness(6).setMeleeDamageMultiplier(0.1).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> KEY_OF_THE_UNKNOWN_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setFort(8).setKnockbackResist(15).setArmor(4).setCon(3).setArmorMultiplier(0.0375).setDebuffResist(5).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Otherworlds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> KEY_OF_THE_UNKNOWN_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setFort(10).setKnockbackResist(15).setArmor(5).setArmorMultiplier(0.075).setCon(6).setDebuffResist(12).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Otherworlds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_TEETH_NECKLACE_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(2).setStr(3).setCritChance(12).setMaxHealth(0.5).setPerc(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_TEETH_NECKLACE_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setStr(6).setCritChance(15).setMaxHealth(1).setPerc(6).setCritDamageMultiplier(0.04).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_TEETH_NECKLACE_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setStr(8).setCritChance(18).setMaxHealth(1.5).setPerc(8).setCritDamageMultiplier(0.08).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> HANGING_TIGER_TOOTH_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setDex(9).setProjectileDamage(7.5).setDrawSpeed(7.5).setAttackSpeed(6).setDebuffResist(10).setDrawSpeedMultiplier(0.05).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Jungle)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> HANGING_TIGER_TOOTH_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setDex(12).setProjectileDamage(12.5).setDrawSpeed(13.5).setAttackSpeed(10).setDrawSpeedMultiplier(0.10).setDebuffResist(12.5).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Jungle)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> BOTTLED_TSUNAMI_SEA_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(1).setFort(4).setSwimSpeed(10).setMaxHealth(0.75).build())
    ...
    public static final RegistryObject<AccessoryItem> BOTTLED_TSUNAMI_SEA_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(2).setFort(7).setSwimSpeed(20).setMaxHealth(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Ocean)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> BOTTLED_TSUNAMI_SEA_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setFort(11).setSwimSpeed(30).setMaxHealth(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Ocean)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> BOTTLED_TSUNAMI_SEA_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setFort(15).setSwimSpeed(40).setMaxHealth(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Ocean)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> STOLEN_LEGACIES_CHOKER_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(3).setXpGain(25).setProjectileDamage(16).setCritDamage(12).setCritDamageMultiplier(0.05).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Pillage)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> STOLEN_LEGACIES_CHOKER_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Necklace)
                    .withStats(new CustomStats.Builder().setInsight(4).setXpGain(30).setProjectileDamage(20).setCritDamage(16).setCritDamageMultiplier(0.1).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Pillage)
                    .build()
    );
