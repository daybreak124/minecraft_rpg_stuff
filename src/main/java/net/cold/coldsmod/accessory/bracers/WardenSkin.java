...
// --- Epic ---
    ...
    private static class WardenSkinBracersEpic extends Item {
        ...
        public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
            ...
            tooltip.add(Component.literal("+3.6 Toughness").withStyle(ChatFormatting.BLUE));
...
// --- Legendary ---
    ...
    private static class WardenSkinBracersLegendary extends Item {
        ...
        public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
            ...
            tooltip.add(Component.literal("+5.5 Toughness").withStyle(ChatFormatting.BLUE));
...
// --- Mythic ---
    ...
    private static class WardenSkinBracersMythic extends Item {
        ...
        public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
            ...
            tooltip.add(Component.literal("+7.25 Toughness").withStyle(ChatFormatting.BLUE));
