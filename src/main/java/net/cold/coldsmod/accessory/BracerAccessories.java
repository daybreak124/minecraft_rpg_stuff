...
public class BracerAccessories {
    ...
    public static final RegistryObject<AccessoryItem> BRACELET_OF_PRIDE_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withStats(new CustomStats.Builder().setStr(3).setCon(2).setFort(2).setInsight(1).build())
    ...
    public static final RegistryObject<AccessoryItem> BRACELET_OF_PRIDE_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(5).setCon(3).setFort(3).setInsight(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> BRACELET_OF_PRIDE_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(7).setCon(4).setFort(4).setDex(3).setInsight(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> BRACELET_OF_PRIDE_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(9).setCon(6).setFort(6).setDex(5).setInsight(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> FINGERS_OF_LUST_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDex(5).setPerc(-6).setAttackSpeed(2).setMeleeDamage(4).setInsight(1).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> FINGERS_OF_LUST_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDex(6).setPerc(-6).setAttackSpeed(3.75).setMeleeDamage(6.75).setInsight(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> FINGERS_OF_LUST_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDex(7).setPerc(-6).setAttackSpeed(4.5).setMeleeDamage(12).setSpeedMultiplier(0.075).setInsight(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> FINGERS_OF_LUST_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDex(8).setPerc(-6).setAttackSpeed(6).setMeleeDamage(18).setSpeedMultiplier(0.15).setInsight(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Hell)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_CLAW_GLOVES_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(3).setCritChance(6).setInsight(1).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_CLAW_GLOVES_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(5).setCritChance(13.5).setInsight(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_CLAW_GLOVES_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(7).setCritChance(18).setToughnessMultiplier(0.075).setInsight(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> DRAGON_CLAW_GLOVES_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setStr(9).setCritChance(24).setToughnessMultiplier(0.15).setInsight(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.End)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> WARDEN_SKIN_FORGED_BRACERS_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setFort(3).setArmor(1).setArmorToughness(1).setInsight(1).setPerc(1).setDebuffResist(6).build())
    ...
    public static final RegistryObject<AccessoryItem> WARDEN_SKIN_FORGED_BRACERS_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setFort(5).setArmor(3).setMaxHealth(1).setArmorToughness(2.5).setToughnessMultiplier(0.04).setInsight(3).setPerc(5).setDebuffResist(12).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Otherworlds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> WARDEN_SKIN_FORGED_BRACERS_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setFort(9).setArmor(4).setMaxHealth(2).setArmorToughness(3.5).setToughnessMultiplier(0.08).setInsight(4).setPerc(8).setDebuffResist(15).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Otherworlds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> REINFORCED_STEEL_BRACERS_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setMeleeDamage(4).setArmor(1.25).setMaxHealth(0.25).setInsight(1).build())
    ...
    public static final RegistryObject<AccessoryItem> REINFORCED_STEEL_BRACERS_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setMeleeDamage(7.5).setArmor(2).setMaxHealth(0.6).setInsight(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Undergrounds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> REINFORCED_STEEL_BRACERS_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setMeleeDamage(12).setArmor(3.5).setMaxHealth(1).setCritChanceMultiplier(0.06).setInsight(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Undergrounds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> REINFORCED_STEEL_BRACERS_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setMeleeDamage(16).setArmor(3.5).setMaxHealth(1.5).setCritChanceMultiplier(0.12).setInsight(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Undergrounds)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> SERPENT_SKIN_WRAP_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDrawSpeed(6).setProjectileDamage(12).setInsight(1).setDebuffResist(5).build())
    ...
    public static final RegistryObject<AccessoryItem> SERPENT_SKIN_WRAP_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDrawSpeed(8).setProjectileDamage(16).setInsight(2).setDebuffResist(6).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Jungle)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> SERPENT_SKIN_WRAP_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDrawSpeed(10).setProjectileDamage(20).setDrawSpeedMultiplier(0.04).setProjectileDamageMultiplier(0.0675).setInsight(3).setDebuffResist(8).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Jungle)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> SERPENT_SKIN_WRAP_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setDrawSpeed(12.5).setProjectileDamage(25).setProjectileDamageMultiplier(0.0675).setDrawSpeedMultiplier(0.1175).setInsight(4).setDebuffResist(10).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Jungle)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> WRAPS_OF_THIEVERY_RARE = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.RARE)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setSpeedMultiplier(-0.06).setCritDamage(11).setInsight(1).build())
    ...
    public static final RegistryObject<AccessoryItem> WRAPS_OF_THIEVERY_EPIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.EPIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setSpeedMultiplier(-0.1).setCritDamage(16).setMaxHealth(1).setInsight(2).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Pillage)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> WRAPS_OF_THIEVERY_LEGENDARY = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.LEGENDARY)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setSpeedMultiplier(-0.15).setCritDamage(22).setMaxHealth(2).setMeleeDamageMultiplier(0.09).setInsight(3).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Pillage)
                    .build()
    );
    ...
    public static final RegistryObject<AccessoryItem> WRAPS_OF_THIEVERY_MYTHIC = ITEMS.register(
            ...
            () -> AccessoryItem.builder(new Item.Properties())
                    ...
                    .withRarity(ItemRarity.MYTHIC)
                    .withType(AccessoryItem.AccessoryType.Bracer)
                    .withStats(new CustomStats.Builder().setSpeedMultiplier(-0.15).setCritDamage(27.5).setMeleeDamageMultiplier(0.15).setMaxHealth(2.5).setInsight(4).build())
                    .withLocation(AccessoryItem.AccessoryLocation.Pillage)
                    .build()
    );
