...
import net.cold.coldsmod.menu_stat.FeatMenu;
...
public class ModMenu {
    ...
    public static final RegistryObject<MenuType<FeatMenu>> FEAT_MENU =
            MENUS.register("feat_menu", () -> IForgeMenuType.create(FeatMenu::new));
}