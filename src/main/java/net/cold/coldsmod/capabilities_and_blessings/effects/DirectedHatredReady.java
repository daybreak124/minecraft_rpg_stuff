...
import net.cold.coldsmod.network.HatredSync;
...
public class DirectedHatredReady extends MobEffect {
    public DirectedHatredReady() {
    ...
    public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, AttributeMap pAttributeMap, int pAmplifier) {
        if (pLivingEntity instanceof ServerPlayer serverPlayer) {
            ModMessages.sendToPlayer(new HatredSync.HatredSyncPacket(true), serverPlayer);
        }
    }
    ...
    public void removeAttributeModifiers(@NotNull LivingEntity pLivingEntity, AttributeMap pAttributeMap, int pAmplifier) {
        if (pLivingEntity instanceof ServerPlayer serverPlayer) {
            ModMessages.sendToPlayer(new HatredSync.HatredSyncPacket(false), serverPlayer);
        }
    }
