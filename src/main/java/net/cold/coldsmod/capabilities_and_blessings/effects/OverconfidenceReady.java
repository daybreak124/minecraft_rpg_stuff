...
import net.cold.coldsmod.network.OverconfidenceSync;
...
public class OverconfidenceReady extends MobEffect {
    public OverconfidenceReady() {
    ...
    public void addAttributeModifiers(@NotNull LivingEntity pLivingEntity, AttributeMap pAttributeMap, int pAmplifier) {
        if (pLivingEntity instanceof ServerPlayer serverPlayer) {
            ModMessages.sendToPlayer(new OverconfidenceSync.OverconfidenceSyncPacket(true), serverPlayer);
        }
    }
    ...
    public void removeAttributeModifiers(@NotNull LivingEntity pLivingEntity, AttributeMap pAttributeMap, int pAmplifier) {
        if (pLivingEntity instanceof ServerPlayer serverPlayer) {
            ModMessages.sendToPlayer(new OverconfidenceSync.OverconfidenceSyncPacket(false), serverPlayer);
        }
    }
