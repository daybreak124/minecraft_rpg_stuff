...
public class BlessingMenu extends AbstractContainerMenu {
    ...
    // This constructor is used by the Client to initialize the menu
    public BlessingMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, FriendlyByteBuf.class.cast(null));
    }

    // This constructor is used by the Server
    public BlessingMenu(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
        super(ModMenu.BLESSING_MENU.get(), containerId);
        // If you want the player's normal inventory slots to show up below your stats:
