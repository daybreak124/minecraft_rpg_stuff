    ...
    public static void onLootTableLoad(LootTableLoadEvent event) {
        ...
        if (name.equals(new ResourceLocation("minecraft", "chests/nether_bridge"))) {
            ...
            List<LootEntry> netherLoot = List.of(
                    ...
                    new LootEntry(ModItems.COMMON_SCRAP_ESSENCE.get(), 1, 0.05f* materialMultiplier/2),
                    new LootEntry(ModItems.UNCOMMON_SCRAP_ESSENCE.get(), 1, 0.025f* materialMultiplier/2),
                    new LootEntry(ModItems.RARE_SCRAP_ESSENCE.get(), 1, 0.0125f* materialMultiplier/2),
                    new LootEntry(ModItems.EPIC_SCRAP_ESSENCE.get(), 1, 0.00625f* materialMultiplier/2),
        ...
        if (name.equals(new ResourceLocation("minecraft", "chests/igloo_chest")) ||
            ...
            List<LootEntry> iglooLoot = List.of(
                    ...
                    new LootEntry(ModItems.COMMON_SCRAP_ESSENCE.get(), 1, 2*0.05F* materialMultiplier/2),
                    new LootEntry(ModItems.UNCOMMON_SCRAP_ESSENCE.get(), 1, 2*0.025F* materialMultiplier/2),
                    new LootEntry(ModItems.RARE_SCRAP_ESSENCE.get(), 1, 2*0.0125F* materialMultiplier/2),
                    new LootEntry(ModItems.EPIC_SCRAP_ESSENCE.get(), 1, 2*0.00625F* materialMultiplier/2),
        ...
        if (name.equals(new ResourceLocation("minecraft", "gameplay/fishing/treasure"))) {
            ...
            List<LootEntry> fishingLoot = List.of(
                    ...
                    new LootEntry(ModItems.PEARL_OF_RENEWING.get(), 1, 0.025F * materialMultiplier/24),
                    new LootEntry(ModItems.SHARD_OF_AMPLIFICATION.get(), 1, 0.025F* materialMultiplier/24),
                    new LootEntry(ModItems.UNCOMMON_SCRAP_ESSENCE.get(), 1, 0.025F* materialMultiplier/24),
