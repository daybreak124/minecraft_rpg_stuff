...
public class StatsSyncPacket {
    ...
    private final boolean isScreenOne; // NEW: Identification flag

    public StatsSyncPacket(String attrId, int points, boolean isScreenOne) {
        this.attrId = attrId;
        this.points = points;
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        ctx.enqueueWork(() -> {
            if (Minecraft.getInstance().player != null) {
                String nbtKey = isScreenOne ? "SpentPointsOne" : "SpentPoints";
