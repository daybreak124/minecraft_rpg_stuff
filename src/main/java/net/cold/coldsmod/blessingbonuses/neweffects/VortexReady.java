...
public class VortexReady extends MobEffect {
    ...
    public static final CopyOnWriteArrayList<VortexInstance> activeVortices = new CopyOnWriteArrayList<>();

    public static class VortexInstance {
        final Vec3 pos;
        final Player owner;
        final String levelDim;
        int ticks = 80;

        public VortexInstance(Vec3 pos, Player owner, Level level) {
            this.pos = pos;
            this.owner = owner;
